...
from yata_core.domain.entities import (
    Entity, EntityType, FunctionEntity,
...
class LuaParser:
    ...
    def _extract_local_function(self, node: Node, code: str, file_path: str, entities: list, relationships: list, parent_id: str | None) -> None:
        name_node = node.child_by_field_name("name")
        if not name_node:
            return
    ...
    def _extract_require(self, node: Node, code: str, imports: list) -> None:
