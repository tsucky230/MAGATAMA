...
class HaskellParser:
    ...
    def _extract_data_type(self, node: Node, code: str, file_path: str, entities: list, relationships: list, parent_id: str | None) -> None:
        name_node = node.child_by_field_name("name")
        if not name_node:
            for child in node.children:
                if child.type in ["constructor", "name", "type"]:
    ...
    def _extract_newtype(self, node: Node, code: str, file_path: str, entities: list, relationships: list, parent_id: str | None) -> None:
        self._extract_data_type(node, code, file_path, entities, relationships, parent_id)
