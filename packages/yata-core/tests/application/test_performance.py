...
These tests verify YATA meets performance requirements.
...
from yata_core.application.services.benchmark import Benchmark, PerformanceProfiler
...
class TestQueryPerformance:
    ...
    def populated_graph(self) -> NetworkXKnowledgeGraph:
        ...
        from yata_core.domain.entities.code_entities import (
            FunctionEntity, ClassEntity, MethodEntity,
        )
...
class TestMemoryUsage:
    ...
    def test_startup_memory(self) -> None:
        """Test that importing YATA uses under 100MB."""
        import tracemalloc
        ...
        assert peak_mb < 100, \
            f"Startup memory {peak_mb:.1f}MB exceeds 100MB limit"
    ...
    def test_runtime_memory_with_large_graph(self) -> None:
        ...
        assert peak_mb < 500, \
            f"Runtime memory {peak_mb:.1f}MB exceeds 500MB limit"
...
class TestStartupTime:
    ...
    def test_mcp_server_startup_time(self) -> None:
        ...
        assert elapsed_ms < 2000, \
            f"Server startup {elapsed_ms:.1f}ms exceeds 2000ms limit"
    ...
    def test_parser_initialization_time(self) -> None:
        ...
        assert elapsed_ms < 1000, \
            f"Parser init {elapsed_ms:.1f}ms exceeds 1000ms limit"
    ...
    def test_cold_start_full_workflow(self) -> None:
        ...
        # REQ-NFR-006: Under 2 seconds
        assert elapsed_ms < 2000, \
            f"Cold start {elapsed_ms:.1f}ms exceeds 2000ms limit"
...
class TestBenchmarkSuite:
    ...
    def test_generate_benchmark_report(self) -> None:
        ...
        # Print report
        print("\n" + "=" * 60)
        print("YATA Performance Benchmark Report")
        print("=" * 60)
        for r in results:
            print(f"\n{r.name}:")
