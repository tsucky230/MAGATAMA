...
''')
        ...
        classes = [
            e for e in knowledge_graph.entities.all()
...
class TestParseDirectoryUseCase:
    ...
    @pytest.fixture
    def usecase(
        self, parse_file_usecase: ParseFileUseCase
    ) -> ParseDirectoryUseCase:
...
''')
    ...
    def test_parse_directory_with_exclude(
        self, usecase: ParseDirectoryUseCase
    ) -> None:
...
""")
    ...
    def test_incremental_with_exclude_patterns(
        self, usecase: IncrementalParseUseCase
    ) -> None:
    ...
    def test_incremental_nonexistent_directory(
        self, usecase: IncrementalParseUseCase
    ) -> None:
    ...
    def test_incremental_not_a_directory(
        self, usecase: IncrementalParseUseCase
    ) -> None:
    ...
    def test_hash_persists_across_save_load(
