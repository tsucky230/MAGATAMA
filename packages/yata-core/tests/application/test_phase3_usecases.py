...
class TestPhase3Integration:
    ...
    def comprehensive_graph(self) -> NetworkXKnowledgeGraph:
        ...
        entities = [
            ("UserServiceFactory", EntityType.CLASS, "src/factories/user.py", "Factory for creating user services"),
            ("create_user_service", EntityType.METHOD, "src/factories/user.py", "Create user service instance"),
            ("UserController", EntityType.CLASS, "src/controllers/user.py", "Controller for user operations"),
            ("handle_request", EntityType.METHOD, "src/controllers/user.py", "Handle HTTP request"),
            ("UserService", EntityType.CLASS, "src/services/user.py", "Service for user management"),
