...
from yata_core.domain.errors import EntityNotFoundError, EntityAlreadyExistsError
...
class TestInMemoryEntityRepository:
    ...
    @pytest.mark.unit
    def test_add_entity(self, repo: InMemoryEntityRepository, sample_entity: FunctionEntity) -> None:
        """Test adding an entity."""
        repo.add(sample_entity)
        assert repo.count() == 1

    @pytest.mark.unit
    def test_get_entity(self, repo: InMemoryEntityRepository, sample_entity: FunctionEntity) -> None:
    ...
    @pytest.mark.unit
    def test_add_duplicate_raises_error(self, repo: InMemoryEntityRepository, sample_entity: FunctionEntity) -> None:
    ...
    @pytest.mark.unit
    def test_update_entity(self, repo: InMemoryEntityRepository, sample_entity: FunctionEntity) -> None:
    ...
    @pytest.mark.unit
    def test_update_nonexistent_raises_error(self, repo: InMemoryEntityRepository, sample_entity: FunctionEntity) -> None:
        """Test updating non-existent entity raises error."""
        with pytest.raises(EntityNotFoundError):
            repo.update(sample_entity)

    @pytest.mark.unit
    def test_delete_entity(self, repo: InMemoryEntityRepository, sample_entity: FunctionEntity) -> None:
...
class TestInMemoryRelationshipRepository:
    ...
    @pytest.mark.unit
    def test_add_relationship(self, repo: InMemoryRelationshipRepository, sample_relationship: Relationship) -> None:
