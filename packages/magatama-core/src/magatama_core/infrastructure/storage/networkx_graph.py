    ...
    def remove_file(self, file_path: str) -> int:
        ...
        for entity_id in entities_to_remove:
            ...
            if entity_id.value in self._graph:
                ...
                edges_to_remove = list(self._graph.in_edges(entity_id.value)) + list(
                    self._graph.out_edges(entity_id.value)
                )
...
class _SyncedRelationshipRepository(RelationshipRepository):
    ...
    def __init__(self, inner: InMemoryRelationshipRepository, graph: nx.DiGraph) -> None:
        self._inner = inner
        self._graph = graph
