...
class FunctionEntity(Entity):
    ...
    def signature(self) -> str:
        ...
        params = ", ".join(f"{name}: {typ}" if typ else name for name, typ in self.parameters)
...
class ClassEntity(Entity):
    ...
    method_ids: list[EntityId] = Field(default_factory=list, description="Method entity IDs")
    decorators: list[str] = Field(default_factory=list, description="Decorators")
...
class TypeEntity(Entity):
    ...
    type_params: list[str] = Field(default_factory=list, description="Generic type parameters")
...
class InterfaceEntity(Entity):
    ...
    method_signatures: list[str] = Field(default_factory=list, description="Method signatures")
    extends: list[str] = Field(default_factory=list, description="Extended interfaces")
...
class StructEntity(Entity):
    ...
    fields: list[tuple[str, str]] = Field(default_factory=list, description="Struct fields")
    type_params: list[str] = Field(default_factory=list, description="Generic type parameters")
