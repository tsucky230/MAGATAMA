...
class MagatamaError(Exception):
    """
    Base exception for all MAGATAMA errors.
...
class EntityError(MagatamaError):
...
class ParsingError(MagatamaError):
    """
...
class ValidationError(MagatamaError):
    """
...
class StorageError(MagatamaError):
    """
...
class ConfigurationError(MagatamaError):
    """
