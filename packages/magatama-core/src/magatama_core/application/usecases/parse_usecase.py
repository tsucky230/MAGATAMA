...
from magatama_core.domain.repositories import KnowledgeGraphRepository
from magatama_core.infrastructure.parsers.parse_result import ParseResult as ParserResult
